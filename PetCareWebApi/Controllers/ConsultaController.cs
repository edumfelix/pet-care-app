...
namespace PetCareWebApi.Controllers
{
    ...
    public class ConsultaController : ControllerBase
    {
        ...
        public ConsultaController(IConsultaRepository repository, NotificationSubject notificationSubject)
        {
        ...
        public async Task<ActionResult<ConsultaVO>> Create(ConsultaVO vo)
        {
            ...
            Console.WriteLine("Notificando os Observadores...");
            _ = _notificationSubject.NotifyObservers("Consulta Criada", consulta);
